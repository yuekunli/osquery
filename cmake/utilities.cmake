...
function(add_osquery_static_lib)
  set(osquery_exe_options EXCLUDE_FROM_ALL;WIN32;MACOSX_BUNDLE)
  set(osquery_exe_ARGN ${ARGN})
  ...
  #add_executable(${osquery_exe_name} ${osquery_exe_args})
  add_library(${osquery_exe_name} STATIC ${osquery_exe_args})
...
function(add_osquery_dynamic_lib)
  set(osquery_exe_options EXCLUDE_FROM_ALL;WIN32;MACOSX_BUNDLE)
  set(osquery_exe_ARGN ${ARGN})
  ...
  #add_executable(${osquery_exe_name} ${osquery_exe_args})
  add_library(${osquery_exe_name} MODULE ${osquery_exe_args})
endfunction()




function(add_osquery_test_exe)
  set(osquery_exe_options EXCLUDE_FROM_ALL;WIN32;MACOSX_BUNDLE)
  set(osquery_exe_ARGN ${ARGN})
